...
Shader "Polygon Wind/Tree" {
    ...
    Properties {
        ...
        _WindNoise ("Main Texture", 2D) = "white" {}
        ...
        #pragma surface surf Lambert vertex:vert addshadow
            ...
            fixed4 _Tint;
                ...
                void vert (inout appdata_full i) {
                    ...
                    i.vertex.y += worldPos.x * 0.5 * cos(_Time.w * _tree_sway_speed + _wind_dir.y + ((worldPos.x + worldPos.y + worldPos.z) * 1) + (i.vertex.x+300)) * _branches_disp * i.color.r * _r_influence;
